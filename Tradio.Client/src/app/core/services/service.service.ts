...
export class ServiceService {
  ...
  getServices(pageNumber: number, pageSize: number, options?: {categoryId?: number, countryId?: number, cityId?: number, subName?: string}): Observable<ServiceListItemModule[]> {
