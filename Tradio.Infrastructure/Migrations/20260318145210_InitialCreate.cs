    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ApplicationUserServiceId = table.Column<int>(type: "int", nullable: false),
                    IsFromProvider = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditReturning = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DurationInDays", "Name", "PriceInCents" },
                values: new object[,]
                {
                    { 1, 30, "Standart", 1000 },
                    { 2, 90, "Premium", 2500 },
