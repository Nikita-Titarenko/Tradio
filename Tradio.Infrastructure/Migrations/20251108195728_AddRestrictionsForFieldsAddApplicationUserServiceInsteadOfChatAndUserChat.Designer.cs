...
namespace Tradio.Infrastructure.Migrations
{
    ...
    [Migration("20251108195728_AddRestrictionsForFieldsAddApplicationUserServiceInsteadOfChatAndUserChat")]
    partial class AddRestrictionsForFieldsAddApplicationUserServiceInsteadOfChatAndUserChat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tradio.Domain.Message", b =>
                {
                    ...
                    b.Property<string>("ApplicationUserServiceApplicationUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ApplicationUserServiceServiceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApplicationUserServiceApplicationUserId", "ApplicationUserServiceServiceId");
            ...
            modelBuilder.Entity("Tradio.Domain.Message", b =>
                {
                    b.HasOne("Tradio.Domain.ApplicationUserService", "ApplicationUserService")
                        .WithMany()
                        .HasForeignKey("ApplicationUserServiceApplicationUserId", "ApplicationUserServiceServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
