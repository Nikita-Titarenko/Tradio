...
namespace Tradio.Infrastructure.Migrations
{
    ...
    [Migration("20251115110130_AddMaxLengthForVerificationCodeAndFullname")]
    partial class AddMaxLengthForVerificationCodeAndFullname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tradio.Domain.ComplaintReply", b =>
                {
                    ...
                    b.HasOne("Tradio.Domain.Complaint", "Complaint")
                        ...
                        .HasForeignKey("Tradio.Domain.ComplaintReply", "ComplaintId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
