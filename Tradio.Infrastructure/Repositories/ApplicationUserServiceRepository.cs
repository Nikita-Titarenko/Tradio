...
namespace Tradio.Infrastructure.Repositories
{
    public class ApplicationUserServiceRepository : Repository<ApplicationUserService>, IApplicationUserServiceRepository
    {
        ...
        public async Task<ApplicationUserServiceDto?> GetApplicationUserServiceAsync(string userId, int serviceId)
        {
            return await _dbSet
                .Where(us => us.ApplicationUserId == userId && us.ServiceId == serviceId)
